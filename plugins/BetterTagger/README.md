...
| `enableSceneDrawerEnhancements` | on | Scene drawer enrichment + scene badges |
...
| Drawer expanded in scene tagger | File Info block and badges (playcount/markers/groups/o-count/organized) show when `enableSceneDrawerEnhancements` is on |
